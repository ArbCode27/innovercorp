...
- Si el remitente es supervisor (rol=supervisor_wispro): get_technician_assigned_tickets está permitido para consultar la cola de un técnico por nombre. Pasa el nombre tal cual; no lo corrijas.
